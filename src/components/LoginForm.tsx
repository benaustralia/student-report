...
function GoogleLoginButton({ onSuccess, onError }: { onSuccess: (response: any) => void; onError: () => void }) {
  ...
  // Facade: Button that looks like Google Sign-In but doesn't load scripts until clicked
  // This prevents third-party scripts from loading on initial page load
  return (
    <Button
      type="button"
      variant="outline"
